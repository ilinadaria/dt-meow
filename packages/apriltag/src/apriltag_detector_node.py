...
class AprilTagDetector(DTROS):
    def __init__(self):
        ...
        #absolutely NO idea why remapping doesn't work here. 
        self._img_sub = rospy.Subscriber(
            "/meow/camera_node/image/compressed", CompressedImage, self._img_cb, queue_size=1, buff_size="20MB"
        )

        # NO idea why remapping doesnt work here either. 
        self._cinfo_sub = rospy.Subscriber("/meow/camera_node/camera_info", CameraInfo, self._cinfo_cb, queue_size=1)
        # create publisher
